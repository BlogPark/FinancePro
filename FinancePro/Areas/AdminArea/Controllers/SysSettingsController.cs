...
namespace FinancePro.Areas.AdminArea.Controllers
{
    ...
    public class SysSettingsController : Controller
    {
        ...
        private SystemConfigsBLL configbll = new SystemConfigsBLL();
        ...
        [HttpPost]
        public ActionResult AddSysConfigs(SystemConfigsModel AConfig)
        {
            if (AConfig != null)
            {
                int rowcount = configbll.AddNewSystemConfigs(AConfig);
            }
            return RedirectToAction("SysConfigs", "SysSettings", new { area = "AdminArea" });
        }
        [HttpPost]
        public ActionResult UpdateConfigs(SystemConfigsModel UConfig)
        {
            if (UConfig != null)
            {
